    ...
    <div class="container mt-3">
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title float-left"><b>Data pelanggaran Tatib</b></p>
      ...
      <template v-slot:modal-title>
        ...
        <form ref="form">
          <div class="form-group">
            <label for="nama" class="col-form-label">Nama Pelanggaran</label>
            <b-form-input type="text" placeholder="Nama Pelanggaran" v-model="nama_pelanggaran"></b-form-input>
          </div>
          <div class="form-group">
            <label for="kategori" class="col-form-label">Kategori</label>
            <b-form-select id="kategori" v-model="kategori" :options="kategori_pelanggaran"></b-form-select>
          </div>
          <div class="form-group">
            <label for="jml_poin" class="col-form-label">Jumlah Poin</label>
            <b-form-input type="number" v-model="poin" placeholder="Poin"></b-form-input>
          </div>
        </form>
    </b-modal>
  ...
  data : function(){
    return {
      ...
      kategori_pelanggaran: [
          {value: "kerapian", text: "Kerapian"},
          {value: "kedisiplinan", text: "Kedisiplinan"},
          {value: "kerajinan", text: "Kerajinan"},
      ]
    }
  },
